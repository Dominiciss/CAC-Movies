...
<body>
    ...
    <main>
        <div class="card">
            ...
            <form class="login" action="../assets/php/login.php" method="POST" enctype="multipart/form-data">
                <div class="input">
                    <span class="error hidden">El email no puede estar vacio y tiene que ser valido</span>
                    <input name="email" type="text" placeholder=" " autocomplete="true">
                    <label for="email">Email</label>
                </div>
                <div class="input">
                    <span class="error hidden">La clave tiene que tener mas de 4 caracteres</span>
                    <input name="password" type="password" placeholder=" " autocomplete="true">
                    <label>Clave</label>
                </div>
                <div class="button">
